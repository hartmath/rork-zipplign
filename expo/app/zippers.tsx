...
const mockZipperPosts: ZipperPost[] = [
  {
    ...
    description: 'Just finished this amazing digital art piece! What do you think? 🎨✨ #DigitalArt #Creative',
    likes: 1250,
    comments: 89,
    shares: 45,
    bookmarks: 234,
  ...
  },
  {
    ...
    description: 'Behind the scenes of my latest logo design process 💼 Follow for more design tips!',
    likes: 890,
    comments: 67,
    shares: 23,
    bookmarks: 156,
  ...
  {
    id: '3',
    username: 'photomaster_alex',
    userAvatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150',
    thumbnail: 'https://images.unsplash.com/photo-1606983340126-99ab4feaa64a?w=400',
    description: 'Golden hour photography tips that changed my game 📸 Save this for later!',
    likes: 2100,
    comments: 156,
    shares: 78,
    bookmarks: 445,
  ...
  {
    id: '4',
    username: 'musicmaker_jay',
    userAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150',
    thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400',
    description: 'Creating beats in my home studio 🎵 New track coming soon! Who wants a collab?',
    likes: 1680,
    comments: 234,
    shares: 92,
    bookmarks: 378,
  ...
  },
  {
    ...
    description: 'Styling tips for the perfect winter look ❄️✨ Link in bio for outfit details!',
    likes: 3200,
    comments: 189,
    shares: 145,
    bookmarks: 567,
...
export default function ZippersScreen() {
  ...
  const [followedUsers, setFollowedUsers] = useState<Set<string>>(
    new Set(mockZipperPosts.filter(post => post.isFollowing).map(post => post.username))
  );
  ...
  const renderPost = ({ item, index }: { item: ZipperPost; index: number }) => {
