          ...
          <View style={[styles.content, { paddingBottom: insets.bottom + 60 }]}>
            <View style={styles.sidebar}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => handleZipJoin(item.id)}
              >
                <View style={styles.zipButtonInner}>
                  <Text style={styles.zipButtonText}>Z</Text>
                </View>
                <Text style={styles.actionText}>{item.zippers}</Text>
              </TouchableOpacity>
